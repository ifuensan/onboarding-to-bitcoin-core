...
. https://github.com/bitcoin/bitcoin/tree/master/CONTRIBUTING.md[CONTRIBUTING.md^] -- Cómo empezar a contribuir al proyecto. (Bifurcar, crear ramas, `commitar` parches)
